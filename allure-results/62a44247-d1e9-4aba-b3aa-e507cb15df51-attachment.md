...
- Name: Selenium-playground\ConfirmationAlert.test.ts >> alerts
- Location: playwright_1\tests\Selenium-playground\ConfirmationAlert.test.ts:3:1
...
> 4  |     await page.goto("https://www.testmuai.com/selenium-playground/javascript-alert-box-demo/",{waitUntil:"networkidle"})
  ...
  8  |         await alert.dismiss()
  9  |     })
  10 | 
  11 |     await page.locator("(//button[text()='Click Me'])[2]").click()
  12 |     await expect(page.locator("#confirm-demo")).toHaveText("You pressed Cancel!")
  13 |     
  14 | })
```