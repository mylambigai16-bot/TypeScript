...
- generic [ref=e1]:
  ...
  - banner [ref=e28]:
    - generic [ref=e30]:
      ...
      - generic [ref=e36]:
        - textbox "Search" [active] [ref=e37]: mac book
...
```ts
  ...
  11 |         await homePage.searching("mac book")
  12 |         const products = await searchPage.listProduct();
  13 |         const listP = await products.allInnerTexts();
  14 |         for (var pro of listP)
> 15 |             expect(pro).toContain("MacBook")
     |                         ^ Error: expect(received).toContain(expected) // indexOf
  16 |     })
  17 | 
  18 | })
